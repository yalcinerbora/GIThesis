...
{
	std::copy(matrix.getColumn(0), matrix.getColumn(0) + 4, v + 0);
	std::copy(matrix.getColumn(1), matrix.getColumn(1) + 4, v + 3);
	std::copy(matrix.getColumn(2), matrix.getColumn(2) + 4, v + 6);
	return *this;
}
