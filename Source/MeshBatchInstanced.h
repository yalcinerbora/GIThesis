...
*/
#ifndef __MESHBATCHINSTANCED_H__
#define __MESHBATCHINSTANCED_H__
...
class MeshBatchInstanced : public MeshBatchI
{
    private:
    ...
    public:
                                ...
                                MeshBatchInstanced(const char* sceneFileName,
                                                   float minVoxSpan,
                                                   bool isSkeletal);
...
#endif //__MESHBATCHINSTANCED_H__